...
if ($_GET[action]=="dump" && $_GET[id]<$number_of_sites) {
	...
	if($stmt = $mysqli->prepare
			   ("SELECT id,timestamp,php_self,remote_addr,http_host,request_uri,http_referer,http_user_agent FROM $tablename[$siteid] ORDER BY remote_addr DESC, timestamp DESC"))
		{
	...
	echo "<br />";
	echo "<div style = 'text-align: center'><a href='sort_by_ip.php'>Sort list by remote_addr</a></div>";
	}
//
//
//  
