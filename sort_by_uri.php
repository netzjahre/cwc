...
if ($_GET[action]=="dump" && $_GET[id]<$number_of_sites) {
	...
	if($stmt = $mysqli->prepare
			...
			ORDER BY url,remote_addr,timestamp;"))
	{
		...
		while($stmt->fetch())
		{
			...
			<td style='word-break: break-all; word-wrap: break-word;'>$url</td>
	...
	echo "<br />";
	echo "<div style = 'text-align: center'><a href='sort_by_ip.php'>Sort list by IP</a></div>";
}
//
//
//
